...
const PROXY_BASE = '';
const APP_ID = '6a2c5f0c38e206d8f43b2a0b';
...
export default function PublicFormBaustellen() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Baustellen — Formular</h1>
        </div>
