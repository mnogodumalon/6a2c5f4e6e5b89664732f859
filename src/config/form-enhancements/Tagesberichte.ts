// Auto-generated. Per-entity form-enhancements config for "Tagesberichte".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["baustelle", "berichtsdatum", {"row": ["verfasser_vorname", "verfasser_nachname"]}, "wetterbedingungen", "mitarbeiter_anzahl", "durchgefuehrte_arbeiten", "besonderheiten_tag", "naechste_schritte", "freigabe_vorgesetzter", "freigabe_bemerkung"],
  defaults: {
    'berichtsdatum': { kind: 'today' },
    'mitarbeiter_anzahl': { kind: 'literal', value: 1 },
    'wetterbedingungen': { kind: 'lookup', key: 'bewoelkt', label: 'Bewölkt' },
    'freigabe_vorgesetzter': { kind: 'literal', value: false },
  },
  computed: {},
};
