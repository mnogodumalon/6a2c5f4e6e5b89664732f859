// Auto-generated. Per-entity form-enhancements config for "Fotodokumentation".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["baustelle", "fotokategorie", "aufnahmedatum", "foto_beschreibung"],
  defaults: {
    'aufnahmedatum': { kind: 'today', withTime: true },
    'fotokategorie': { kind: 'lookup', key: 'waehrend_arbeiten', label: 'Während der Arbeiten' },
  },
  computed: {},
};
