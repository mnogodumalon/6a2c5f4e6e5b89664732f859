// Auto-generated. Per-entity form-enhancements config for "Vor-Ort-Checkliste".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["baustelle", "pruefzeitpunkt", "pruefer", "absperrungen_korrekt", "parkverbote_eingerichtet", "anwohner_informiert", "grabengroesse_korrekt", "bemerkungen"],
  defaults: {
    'pruefzeitpunkt': { kind: 'today', withTime: true },
  },
  computed: {},
};
