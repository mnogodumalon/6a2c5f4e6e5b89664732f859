// Auto-generated. Per-entity form-enhancements config for "Kommunikation".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["baustelle", {"row": ["kontakt_vorname", "kontakt_nachname"]}, {"row": ["kontakt_adresse_strasse", "kontakt_adresse_hausnummer"], "cols": "2fr 1fr"}, {"row": ["kontakt_adresse_plz", "kontakt_adresse_ort"], "cols": "1fr 2fr"}, "kontakt_telefon", "kontakt_email", "gespraechsdatum", "kontaktart", "gespraechsnotiz", "besonderheiten"],
  defaults: {
    'gespraechsdatum': { kind: 'today', withTime: true },
    'kontaktart': { kind: 'lookup', key: 'information', label: 'Information' },
  },
  computed: {},
};
