// Auto-generated. Per-entity form-enhancements config for "Baustellen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["name", "status", "beschreibung", {"row": ["startdatum", "enddatum"]}, {"row": ["strasse", "hausnummer"], "cols": "2fr 1fr"}, {"row": ["plz", "ort"], "cols": "1fr 2fr"}, "zustaendige_person", "auftraggeber", "notizen"],
  defaults: {
