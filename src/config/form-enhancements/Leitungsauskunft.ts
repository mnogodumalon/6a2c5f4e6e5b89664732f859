// Auto-generated. Per-entity form-enhancements config for "Leitungsauskunft".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["baustelle", "hausanschluss_typ", "spannungsebene", "hausanschluss_info", "muffentyp", "material", "leitungsfuehrung"],
  defaults: {},
  computed: {},
};
